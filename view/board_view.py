...
class BoardView:
    ...
    def load_pictures(self):
        ...
        self.pieces_images['P'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "white-pawn.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['N'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "white-knight.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['B'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "white-bishop.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['R'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "white-rook.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['Q'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "white-queen.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['K'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "white-king.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['p'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "black-pawn.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['n'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "black-knight.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['b'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "black-bishop.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['r'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "black-rook.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['q'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "black-queen.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
        self.pieces_images['k'] = pg.transform.scale(pg.image.load(os.path.join(pics_dir, "black-king.png")), (PIECE_SIZE, PIECE_SIZE)).convert_alpha()
