...
### This project is my theses for my bachelor degree
---
...
- **nn-04cf2b4ed1da.nnue** NNUE from [Stockfish] - https://github.com/official-stockfish/networks


You can see how NNUE is integrated into the engine in [Cincinnatus repo](https://github.com/boce1/cincinnatus.git).
...
![gui screenshot 2](pics/gui_promotion_demo.png)
...
Modern chess GUIs like Arena, CuteChess, LucasChess can modify the time for the game, moves to go and increment seconds for move. This gui can't do that. The idea for this gui is not to test other engines and do tournaments with them but to demonstrate how Cincinnatus egnine work.


Note: Engine is backend of a chess simulator. It's called engine because, chess bots are made such that they can be pluged and play for every GUI. The engine and GUI communicate using protocol. The most popular are UCI and xboard.
